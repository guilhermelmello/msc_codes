...
#SBATCH -n 64
#SBATCH --gres=gpu:8
#SBATCH --output=./logs/mlm_xlmr_carolina_base.log
...
mkdir -p /output/gmello/run_mlm/results/mlm_xlmr_carolina_base
...
docker run \
    ...
    --output_dir ./results/mlm_xlmr_carolina_base \
    --low_cpu_mem_usage \
    --seed 42 \
    --fp16
...
echo "Saving project results to /home/gmello/msc_codes/run_mlm/results/mlm_xlmr_carolina_base"
cp -r /output/gmello/run_mlm/results/mlm_xlmr_carolina_base /home/gmello/msc_codes/run_mlm/results
