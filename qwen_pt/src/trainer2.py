...
if __name__ == '__main__':
    ...
    dataset = load_from_disk('/work/gmello/datasets/clm-1024-bpe-pt-8k/validation')
    ...
    tokenizer = AutoTokenizer.from_pretrained('/home/lovelace/proj/proj877/gmello/msc_codes/tokenizers/bpe-qwen-pt/models/bpe8k-nfc/')
    print(tokenizer)
    ...
    output_path = './models/qwen-pt-bpe8k-nfc'
